...
public class ExitOperation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exit_operation);
        ...
        tvbtnmanualtype = findViewById(R.id.tvBtnFormExit);
        linearmanual = findViewById(R.id.linearManualFormExit);
        gridnumpad = findViewById(R.id.gridNumberPadExit);
        etidcode = findViewById(R.id.etRfidCodeExit);
        linearformclose = findViewById(R.id.linearButtonCloseExit);
        btnclear = findViewById(R.id.btnClearExit);
        etscanneddata = findViewById(R.id.etScannedRfidExit);
        linearbtnlogout = findViewById(R.id.linearButtonLogoutExit);
        linearprogress = findViewById(R.id.linearProgressExit);
        btncontinue = findViewById(R.id.btnContinueExit);
        ...
        btncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty()){
                    showWarningDialog(ExitOperation.this);
                }else {
                    showSelectorDialog(ExitOperation.this);
                }
            }
        });
        ...
        tvbtnmanualtype.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                toggleManualFormVisibility(); // Call the method to toggle visibility
            }
        });
        ...
        if (nfcAdapter == null){
            Toast.makeText(this, "NFC is not supported onn this device!", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
    }
    ...
    private class HttpRequestTaskCheck extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String result) {
            if (result != null){
                ...
                errorDialog(ExitOperation.this);
                linearprogress.setVisibility(View.GONE);
    ...
    private class HttpRequestTask extends AsyncTask<String, Void, String>{
        ...
        protected String doInBackground(String... params) {
            String code = params[0];
            String apiUrl ="http://192.168.1.154/jhctc/API/exit?idcode=" + code;
                ...
                if (status.equals("success")){
                    if (jsonObject.has("information")){
                        ...
                        if (position.equals("Student")){
                            ...
                            showClientExitInformationDialog(username, clientpos, rfidcode, idnumber, department, entrytime, fullimage);
                    ...
                    blockedDialog(ExitOperation.this);
                }else if (status.equals("failed")){
                    failedDialog(ExitOperation.this);
                }else {
                    warningDialog(ExitOperation.this);
                }
            }
                ...
                if (status.equals("success")){
                    if (jsonObject.has("information")){
                        ...
                        if (position.equals("Student")){
                            ...
                            String idnumber = clientObject.getString("id_number");
                            String department = clientObject.getString("department");
                            String exittime = clientObject.getString("out_time");
                            String image = clientObject.getString("image");
                            String fullimage = serverurl + image;
                            showClientExitInformationDialog(username, clientpos, rfidcode, idnumber, department, exittime, fullimage);
                        }else if (position.equals("Faculty")){
                            String username = clientObject.getString("username");
                            String clientpos = clientObject.getString("type");
                            String rfidcode = clientObject.getString("rfid");
    ...
    private void showClientExitInformationDialog(String username, String clientpos, String rfidcode, String idnumber, String department, String exittime, String imageUrl) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        ...
        entryTimeTextView.setText(exittime);
        tvlabel.setText("Exit Time");
    ...
    private void failedDialog(Context context){
        ...
        tvmessage.setText("This client has no record in Entry.");
